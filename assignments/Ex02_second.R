...
#' - Gib alle Temperaturen aus die zwischen 19 und 21°C liegen. 
#' Tipp: Dafür benötigt es zwei logische Abfragen die mit `&` (sprich UND) verknüpft werden.



#' - Gib alle Werte aus die mehr als 0.5 von der mittleren Temperatur abweichen.
#' Tipp: Dafür benötigt es zwei logische Abfragen die mit `|` (sprich ODER) verknüpft werden.
