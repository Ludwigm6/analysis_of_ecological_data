...
temperature[order(temperature)] # ordnen nach index
...
temp20 = temperature[1:20]
1:20
seq(1,20)

low30 = order(temperature)[1:30]
temperature[low30]

temp_sorted = sort(temperature)

temp_sorted[1:30]

sort(temperature)[1:30]
sort(temperature[1:30])
```
...
# gibt den index wo die abfrage TRUE ist
which(temperature > 22)
temperature[which(temperature > 22)]
